 ...
 *
 */
if ( ! class_exists( 'WPAS_Abstract' ) ) {
#[AllowDynamicProperties]
abstract class WPAS_Abstract {
  ...
  public function __construct() {
    ...
    if ( ! empty( $this->args['output_css'] ) || ! empty( $this->args['enqueue_webfont'] ) ) {
      ...
      WPAS::$css = apply_filters( "wpas_{$this->unique}_output_css", WPAS::$css, $this );
    }
  ...
  public function recursive_output_css( $fields = array(), $combine_field = array() ) {
    ...
    if ( ! empty( $fields ) ) {
      ...
      foreach ( $fields as $field ) {
        ...
        $field_class  = 'WPAS_Field_' . $field_type;
