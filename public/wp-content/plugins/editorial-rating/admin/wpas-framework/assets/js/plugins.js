...
* MIT License
*
* Customized by Editorial Rating
*
*/
(function($) {

  function WPASAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  WPASAjaxChosen.prototype.init = function() {
  ...
  WPASAjaxChosen.prototype.events = function() {
  ...
  WPASAjaxChosen.prototype.search_field_focused = function() {
  ...
  WPASAjaxChosen.prototype.search_welcome_message = function() {
  ...
  WPASAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('wpas-chosen', _this.options.data).done( function( response ) {
  ...
  WPASAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.wpas-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.WPASChosenOrder($hidden_value, true);
  ...
  $.fn.WPASAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new WPASAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, WPASAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  WPASAbstractChosenOrder = (function() {

    function WPASAbstractChosenOrder() {}

    WPASAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    WPASAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    WPASAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    WPASAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    WPASAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    WPASAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    WPASAbstractChosenOrder.WPASChosenOrder = function(select, order, force) {
    ...
    return WPASAbstractChosenOrder;
  ...
  $.fn.extend({
    WPASChosenOrder: function(order, force) {
      return _WPASChosenOrder.WPASChosenOrder(this, order, force);
    }
  });

  this._WPASChosenOrder = (function(_super) {
    __extends(_WPASChosenOrder, _super);

    function _WPASChosenOrder() {
      _ref = _WPASChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _WPASChosenOrder.relAttributeName = 'data-option-array-index';

    _WPASChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _WPASChosenOrder.getDOMElement = function(element) {
    ...
    _WPASChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _WPASChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _WPASChosenOrder;

  })(WPASAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('wpas-depend-on');
        });
...
(function(root, factory) {
  ...
  //
  // Editorial Rating: Added custom patterns for spesific validate
  //
  var patterns = {
  ...
  //
  // Editorial Rating: Renamed function names for avoid conflicts
  //

  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectWPAS = FormSerializer.serializeObject;
    $.fn.serializeJSONWPAS   = FormSerializer.serializeJSON;
  }
