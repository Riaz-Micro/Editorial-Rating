 ...
 * -----------------------------------------------------------
 *
 * Editorial Rating Framework Gutenberg Block
...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.wpas_gutenberg_blocks ) { return; }

  Object.values(window.wpas_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'wpas-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary wpas-shortcode-button',
              onClick: function () {
                window.wpas_gutenberg_props = props;
              },
            }, block.button_title ),
