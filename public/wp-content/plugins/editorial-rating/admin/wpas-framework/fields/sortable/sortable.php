 ...
 *
 */
if ( ! class_exists( 'WPAS_Field_sortable' ) ) {
  class WPAS_Field_sortable extends WPAS_Fields {
    ...
    public function render() {
      ...
      echo '<div class="wpas-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="wpas-sortable-item">';

          echo '<div class="wpas-sortable-content">';
          ...
          WPAS::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="wpas-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
