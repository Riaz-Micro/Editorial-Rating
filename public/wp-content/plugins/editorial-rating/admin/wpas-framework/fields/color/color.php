 ...
 *
 */
if ( ! class_exists( 'WPAS_Field_color' ) ) {
  class WPAS_Field_color extends WPAS_Fields {
    ...
    public function render() {
      ...
      echo '<input type="text" name="'. esc_attr( $this->field_name() ) .'" value="'. esc_attr( $this->value ) .'" class="wpas-color"'. $default_attr . $this->field_attributes() .'/>';
