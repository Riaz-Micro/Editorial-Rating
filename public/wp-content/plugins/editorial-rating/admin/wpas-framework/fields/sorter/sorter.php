 ...
 *
 */
if ( ! class_exists( 'WPAS_Field_sorter' ) ) {
  class WPAS_Field_sorter extends WPAS_Fields {
    ...
    public function render() {
      ...
      $args = wp_parse_args( $this->field, array(
        'disabled'       => true,
        'enabled_title'  => esc_html__( 'Enabled', 'wpas' ),
        'disabled_title' => esc_html__( 'Disabled', 'wpas' ),
      ) );
      ...
      echo '<div class="wpas-sorter" data-depend-id="'. esc_attr( $this->field['id'] ) .'"></div>';

      echo ( $args['disabled'] ) ? '<div class="wpas-modules">' : '';

      echo ( ! empty( $args['enabled_title'] ) ) ? '<div class="wpas-sorter-title">'. esc_attr( $args['enabled_title'] ) .'</div>' : '';
      echo '<ul class="wpas-enabled">';
      ...
      if ( $args['disabled'] ) {
        ...
        echo '<div class="wpas-modules">';
        echo ( ! empty( $args['disabled_title'] ) ) ? '<div class="wpas-sorter-title">'. esc_attr( $args['disabled_title'] ) .'</div>' : '';
        echo '<ul class="wpas-disabled">';
