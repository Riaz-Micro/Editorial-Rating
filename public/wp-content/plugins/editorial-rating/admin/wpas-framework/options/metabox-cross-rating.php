...
WPAS::createSection(
	...
	array(
		'fields' => array(
			...
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-1.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-1' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-2.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-2' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-3.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-3' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-4.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-4' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-5.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-5' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-6.jpg">',
				'class'      => 'wpas-theme-prev-list',
				'dependency' => array( 'wpas-cr-theme-set', '==', 'set-6' ),
			),
			array(
				'type'       => 'content',
				'content'    => '<img src="' . WPASER_DIR_URL_FILE . 'admin/img/cr-template/cr-7.jpg">',
				'class'      => 'wpas-theme-prev-list',
			...
			array(
				...
				'dependency' => array( 'wpas-cr-theme-set', 'not-any', 'set-1,set-6' ),
