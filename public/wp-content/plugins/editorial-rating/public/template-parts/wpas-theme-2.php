...
// Enqueuing.
wp_enqueue_style( $this->plugin_name . '-theme-2' );
...
// Dynamic Styles.
echo '<style>.wpas--rating-content .wpas--rating-title + p {color: ' . esc_attr( $wpas_product_overview_color ) . ';}</style>';
?>
<div id="wpas-er-<?php echo esc_attr( $wpas_post_id ); ?>" class="wpas--rating-wrap wpas-theme-2" data-id="<?php echo esc_attr( $wpas_post_id ); ?>" data-vote="<?php echo esc_attr( $frhd_total_vote ); ?>" data-star="<?php echo esc_attr( $frhd_total_star ); ?>" data-baranim="<?php echo esc_attr( $wpas_bar_animation_data ); ?>">
	...
	<div class="wpas--rating-header">
		...
		<div class="frhd-editorial-rating">
			<div class="frhd-editorial-rating-left">
				...
				<span>Based on <?php echo esc_html( $wpas_i ); ?> categories.</span>
			</div>
			<div class="frhd-editorial-rating-right">
				<span class="frhd-editorial-rating-round"><?php echo esc_html( $wpas_total_rating_math_round ); ?></span>
			</div>
		</div>
	...
	<div class="wpas--rating-content">
		...
		<div class="wpas--rating-info" <?php echo $wpas_product_image_url ? '' : 'style="justify-content: center;"'; ?>>
		<?php
